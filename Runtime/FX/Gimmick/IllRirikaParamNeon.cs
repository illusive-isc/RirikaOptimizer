...
{
    [AddComponentMenu("")]
    internal class IllRirikaParamNeon : IllRirikaParam
    {
        VRCAvatarDescriptor descriptor;
        AnimatorController animator;

        private static readonly List<string> MenuParameters = new() { "neon1", "neon2", "neon3" };

        public IllRirikaParamNeon Initialize(
            VRCAvatarDescriptor descriptor,
            AnimatorController animator
        )
        {
        ...
        public IllRirikaParamNeon DeleteParam()
        {
        ...
        public IllRirikaParamNeon DeleteFxBT()
        {
        ...
        public IllRirikaParamNeon DeleteVRCExpressions(
