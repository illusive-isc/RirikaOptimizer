...
{
    [AddComponentMenu("")]
    internal class IllRirikaParamNoisepanel : IllRirikaParam
    {
        VRCAvatarDescriptor descriptor;
        AnimatorController animator;

        private static readonly List<string> MenuParameters = new() { "noisepanel" };

        public IllRirikaParamNoisepanel Initialize(
            VRCAvatarDescriptor descriptor,
            AnimatorController animator
        )
        {
        ...
        public IllRirikaParamNoisepanel DeleteParam()
        {
        ...
        public IllRirikaParamNoisepanel DeleteFxBT()
        {
        ...
        public IllRirikaParamNoisepanel DeleteVRCExpressions(
