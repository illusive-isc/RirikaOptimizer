...
{
    [AddComponentMenu("")]
    internal class IllRirikaParamTPS : IllRirikaParam
    {
        ...
        public IllRirikaParamTPS Initialize(
            VRCAvatarDescriptor descriptor,
            AnimatorController animator
        )
        {
        ...
        public IllRirikaParamTPS DeleteParam()
        {
        ...
        public IllRirikaParamTPS DeleteFxBT()
        {
        ...
        public IllRirikaParamTPS DeleteVRCExpressions(
