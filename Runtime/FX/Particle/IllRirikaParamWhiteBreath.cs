...
{
    [AddComponentMenu("")]
    internal class IllRirikaParamWhiteBreath : IllRirikaParam
    {
        ...
        public IllRirikaParamWhiteBreath Initialize(
            VRCAvatarDescriptor descriptor,
            AnimatorController animator
        )
        {
        ...
        public IllRirikaParamWhiteBreath DeleteParam()
        {
        ...
        public IllRirikaParamWhiteBreath DeleteFxBT()
        {
        ...
        public IllRirikaParamWhiteBreath DeleteVRCExpressions(
